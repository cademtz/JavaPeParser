...
public abstract class EndianReader {
	 ...
	 *
	 * @param maxChars
	 * 		Maximum number of non-null chars before string is considered invalid.
	 *
	 * @return Resulting string, or {@code null}.
	 *
	 * @throws IOException
	 * 		When reading from the {@link #getStream() stream} fails.
	 */
	 ...
	 *
	 * @param bits
	 * 		Size of one array element in bits. Rounded up to the nearest int type (byte, word, dword, qword).
	 * @param term
	 * 		Value signifying the end of an array, typically 0 (null-terminated).
	 * @param maxLength
	 * 		Maximum number of values before the array is considered invalid.
	 *
